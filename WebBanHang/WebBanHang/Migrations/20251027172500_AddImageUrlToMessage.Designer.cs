...
namespace WebBanHang.Migrations
{
    ...
    [Migration("20251027172500_AddImageUrlToMessage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebBanHang.Models.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebBanHang.Models.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebBanHang.Models.CouponSubscriber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebBanHang.Models.Product", b =>
                {
                    ...
                    b.Property<string>("BookContentUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebBanHang.Models.ReadingProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebBanHang.Models.CouponSubscriber", b =>
                {
                    b.HasOne("WebBanHang.Models.Coupon", "Coupon")
            ...
            modelBuilder.Entity("WebBanHang.Models.Message", b =>
                {
                    b.HasOne("WebBanHang.Models.Conversation", "Conversation")
                        .WithMany("Messages")
